...
export const useTodoProjectStore = create<TodoProjectStore>((set, get) => ({
  ...
  // Crea un nuevo proyecto y revalida el array sin mostrar loading
  ...
  // Edita el nombre de un proyecto y revalida el array sin mostrar loading
  ...
  // Borra un proyecto y revalida el array sin mostrar loading
  ...
  // Crea un nuevo todo en un proyecto y actualiza el array global
  ...
  // Actualiza el estado de un todo y refresca el array global
  ...
  // Borra un todo y refresca el array global
